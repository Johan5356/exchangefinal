<%-- 
    ...
    Created on : 2/07/2019, 09:55:34 AM
    Author     : jonathan
--%>
...
<html>
    ...
    <form action="../Editarpublicacion?id=<%=pvo.getId_publicar()%>" enctype="multipart/form-data" method="POST">
        <div class="container">
            <center>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 ">
                    <div class="col-lg-8">
                        ...
                        <input type="text" name="nombre" class="form-control" value="<%=pvo.getNombre()%>">
                        <div>
                            <label for="Descipcion">Descipcion</label>
                            <textarea class="form-control" id="Descripcion" name="descripcion" rows="6"><%=pvo.getDescripcion()%></textarea>
                        </div>
                    </div>	
                    <br>                      
                    <div class="rows ">
                        <div class="form-group">
                            <div class="col-md-6 ">
                                ...
                                <input type="text" name="precio"class="form-control" value="<%=pvo.getPrecioestimado()%>">	
                            </div>
                    ...
                    <div class="form-group">			  
                        <div class="col-md-6 ">
                            <label>Marca</label>
                            <input type="text" name="marca"class="form-control" value="<%=pvo.getMarca()%>">	
                        </div> 
                        <div class="col-md-6 ">
                            <label>Tiempo de uso</label>
                            <input type="text" name="tiempo_uso"class="form-control" value="<%=pvo.getTiempouso()%>">	
                        </div> 
                ...
                <div class="col-sm-4">
                    ...
                    <div>
                        <input class="form-control" type="file" value="<%=pvo.getImagen_1()%>" name="fileimagen" id="archivos" multiple> 
                    </div>
